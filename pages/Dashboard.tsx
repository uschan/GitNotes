...
const Dashboard: React.FC<DashboardProps> = ({ repos, onCreateRepo, isAuthenticated }) => {
  ...
  const handleCreate = (e: React.FormEvent) => {
    ...
    onCreateRepo(newRepoName, newRepoDesc, true); // Default to private for personal use
  ...
  return (
    <div className="p-6 md:p-12 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 border-b border-zenith-border pb-6">
        <div>
          ...
          >
             ...
             <div className="relative z-10">
                <div className="flex items-center justify-between mb-4">
                    <span className="font-mono text-[10px] tracking-widest text-zenith-muted uppercase">ID: {repo.id.toUpperCase()}</span>
      ...
      {/* New Repo Modal - Industrial Style */}
      {showNewRepoModal && (
          ...
          <div className="bg-zenith-bg border border-zenith-border w-full max-w-lg p-0 relative shadow-2xl shadow-black">
            ...
            <form onSubmit={handleCreate} className="p-8 space-y-6">
              <div className="space-y-2">
                <label className="block font-mono text-[10px] tracking-widest text-zenith-muted uppercase">Module Designation (Name)</label>
                <input 
                  autoFocus
                  required
                  value={newRepoName}
              ...
              <div className="space-y-2">
                <label className="block font-mono text-[10px] tracking-widest text-zenith-muted uppercase">Mission Brief (Description)</label>
                <textarea 
                  value={newRepoDesc}
